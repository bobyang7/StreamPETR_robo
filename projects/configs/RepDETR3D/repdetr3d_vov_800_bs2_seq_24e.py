...
data = dict(
    ...
    test=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, ann_file='/home/bo.yang5/other/Sparse4D-full2/data/nuscenes_anno_pkls/nuscenes_infos_val.pkl', classes=class_names, modality=input_modality),

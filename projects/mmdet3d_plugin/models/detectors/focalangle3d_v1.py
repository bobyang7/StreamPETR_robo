...
class FocalAngle3D_V1(MVXTwoStageDetector):
    """FocalAngle3D."""
    ...
    def __init__(self,
                 ...
                 single_test=False,
                 pretrained=None):
        super(FocalAngle3D_V1, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def forward_train(self,
        ...
        for key in data:
            if key != 'gt_depth':
                data[key] = data[key][:, 0] 
        rec_img = data['img']
        rec_img_feats, _ = self.extract_feat(rec_img, True)
    ...
    def simple_test(self, img_metas, **data):
        ...
        data['img_feats'], _ = self.extract_feat(data['img'], True)

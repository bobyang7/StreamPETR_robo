...
class SparseHead_CUSTOM(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is SparseHead_CUSTOM):
        ...
        super(SparseHead_CUSTOM, self).__init__(num_classes, in_channels, init_cfg = init_cfg)

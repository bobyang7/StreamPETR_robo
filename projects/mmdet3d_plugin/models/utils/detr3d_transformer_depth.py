...
class Detr3DTransformerDepth(BaseModule):
    ...
    def __init__(self,
                 decoder=None,
                 **kwargs):
        super(Detr3DTransformerDepth, self).__init__(**kwargs)
...
class DeformableFeatureAggregationCuda(BaseModule):
    ...
    def feature_sampling(self, feat_flatten, spatial_flatten, level_start_index, key_points, weights, lidar2img_mat, img_metas):
        ...
        points_2d[..., 0:1] = points_2d[..., 0:1] / img_metas[0][0]['pad_shape'][0][1]
        points_2d[..., 1:2] = points_2d[..., 1:2] / img_metas[0][0]['pad_shape'][0][0]
